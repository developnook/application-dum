...
<div id="container-product" class="container">
	...
	<div class="section bg-color-black text-color-white">
		...
		<div class="section-control">
			<div>
				<p>ฟันขาวขึ้นอย่างเป็นธรรมชาติ</p>
				<p>ปากสะอาด ลมหายใจสดชื่อตลอดวัน</p>
				<p>ลดอาการเสียวฟันอย่างได้ผล</p>
			</div>
			<div></div>
			<div></div>
		</div>
	...
	<div class="section bg-color-black text-color-white">
		...
		<div class="section-control">
			<div></div>
			<div>
				<p>ช่วยกำจัดและควบคุมการเจริญเติบโตของแบคทีเรีย</p>
				<p>ป้องกันการเกิดคราบพลัคและหินปูสะสม</p>
			</div>
			<div></div>
		</div>
	</div>
