...
#	public static $DB_HOST = "103.7.56.174";
#	public static $DB_HOST = Web::getCfgVar('wurfl_host');
	/**
	 * Database User
...
#	public static $DB_USER = "wurfl_user";
#	public static $DB_USER = Web::getCfgVar('wurfl_user');
	/**
	 * Database Password
	 * For MongoDB, this may be blank if authentication is not used
	 * @var String
...
#	public static $DB_PASS = "evangelion";
#	public static $DB_USER = Web::getCfgVar('wurfl_pass');
	/**
...
#	public static $DB_SCHEMA = Web::getCfgVar('wurfl_base');
	/**
...
#	public static $WURFL_DL_URL = "http://downloads.sourceforge.net/project/wurfl/WURFL/latest/wurfl-latest.zip";
	public static $WURFL_DL_URL = "http://moserv.mobi/wurfl-2.3.1.zip";
	/**
	...
	public static function init() {
		TeraWurflConfig::$DB_HOST = Web::getCfgVar('wurfl_host');
		TeraWurflConfig::$DB_USER = Web::getCfgVar('wurfl_user');
		TeraWurflConfig::$DB_PASS = Web::getCfgVar('wurfl_pass');
		TeraWurflConfig::$DB_SCHEMA = Web::getCfgVar('wurfl_base');
		
	}
}

TeraWurflConfig::init();
